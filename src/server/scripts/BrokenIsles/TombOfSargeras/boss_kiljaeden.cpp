...
/*
    void MovementInform(uint32 type, uint32 pointId) override
    {
        ...
        if (id == 1)
        {
            ...
            me->GetScheduler().Schedule(Milliseconds(4000), [this](TaskContext)
            {
        ...
        else if (id == 2)
        {
            ...
            else if (IsMythicRaid())
            {
                ...
                {
                    me->GetScheduler().Schedule(Milliseconds(timer), [this](TaskContext){ RupturingSingularity(); });
                }
            }

            me->GetScheduler().Schedule(Milliseconds(delayTimer), [this](TaskContext)
            {
                flymove = true;
