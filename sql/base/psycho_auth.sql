-- ===========================================================================
-- Psycho_Core 8.3.7 - AUTH DATABASE  (CONSOLIDATED, FIXED, READY TO IMPORT)
-- Target: psycho_auth on 127.0.0.1:3307  (MariaDB 11.8.6)
-- Source: DB-4/1_auth.sql (matches the core base sql/base/1_auth.sql exactly)
--         + mod-psychobot RBAC permissions
-- ===========================================================================

-- MariaDB 11.x strict mode rejects '0000-00-00' TIMESTAMP defaults used by
-- a couple of legacy columns in this schema. Temporarily relax sql_mode for
-- this import only, then restore it.
