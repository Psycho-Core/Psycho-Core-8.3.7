...
-- Default DB login for worldserver.conf/bnetserver.conf: psycho / core
-- ===========================================================================
...
CREATE USER IF NOT EXISTS 'psycho'@'localhost' IDENTIFIED BY 'core';
CREATE USER IF NOT EXISTS 'psycho'@'127.0.0.1' IDENTIFIED BY 'core';
